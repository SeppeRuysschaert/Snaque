...
export default function Broodje({
  ...
  return (
    <li className="group relative rounded-2xl border border-white/10 bg-white/5 p-4 shadow-sm transition hover:border-white/20 hover:bg-white/10">
      ...
      <div className="flex items-start justify-between gap-3 mt-3">
        ...
        <div className="rounded-xl bg-white/10 px-2 py-1 text-sm font-semibold text-slate-100 ring-1 ring-white/10">
